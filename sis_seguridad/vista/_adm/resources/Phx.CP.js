...
Phx.CP = function() {
    var menu, hd, mainPanel, win_login, form_login, sw_auten = false,
        sw_auten_veri = false,
        estilo_vista;
            ...
            var viewport = new Ext.Viewport({
                ...
                items: [{
                        ...
                        bbar: [{
                                xtype: 'label',
                                width: 500,
                                html: ' <a href="https://www.ofep.gob.bo" target="_blank"><img src="' + Phx.CP.config_ini.mini_logo + '"  style="margin-left:5px;margin-top:1px;margin-bottom:1px"/> </a>',
                                border: false
                            },
                            '->',
                            {
